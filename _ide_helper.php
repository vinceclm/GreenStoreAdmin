...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function url($src, $width = null, $height = null, $options = [])
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->url($src, $width, $height, $options);
        }
                    /**
        ...
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->make($path, $options);
        }
                    /**
         ...
         * @static 
         */ 
        public static function serve($path, $config = [])
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->serve($path, $config);
        }
                    /**
         * Proxy an image
         *
         ...
         * @static 
         */ 
        public static function proxy($path, $config = [])
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->proxy($path, $config);
        }
                    /**
        ...
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->thumbnail($image, $width, $height, $crop);
        }
                    /**
        ...
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        $instance->deleteManipulated($path);
        }
                    /**
         * Get the URL pattern
         *
        ...
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->pattern($parameter, $pattern);
        }
                    /**
        ...
        {
                        /** @var \Folklore\Image\ImageManager $instance */
                        return $instance->getMimeFromFormat($format);
        }
                    /**
