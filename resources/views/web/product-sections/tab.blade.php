            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    <div class="nav" role="tablist" id="tabCarousel">
                        ...
                        <a class="nav-link btn" data-toggle="tab" href="#special" role="tab" aria-controls="special"
                        ...
                        <a class="nav-link btn" data-toggle="tab" href="#liked" role="tab" aria-controls="liked"
                            aria-selected="true"><span data-toggle="tooltip" data-placement="bottom"
                            ...
                            <div class="tab-carousel-js">
                                ...
                                <div class="">
                                    <div class="product">
                                        <article>
                                            <div class="btn-all">
                                                <a href="{{url('/shop?type=topseller')}}"
                                                    class="btn btn-secondary swipe-to-top">@lang('website.View All')</a>
                                            </div>
                                        </article>
                                    </div>
                                </div>
                            ...
                            <div class="tab-carousel-js">
                                ...
                                <div class="">
                                    <div class="product">
                                        <article>
                                            <div class="btn-all">
                                                <a href="{{url('/shop?type=mostliked')}}"
                                                    class="btn btn-secondary swipe-to-top">@lang('website.View All')</a>
                                            </div>
                                        </article>
                                    </div>
