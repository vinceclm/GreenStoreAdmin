                ...
                <div class="col-12 media-main p-3 mb-3">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="middleName" class="col-sm-4 col-form-label">@lang('website.Middle Name')</label>
                                <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-12 col-md-6 row">
                                <label for="placeOfBirth" class="col-sm-4 col-form-label">@lang('website.Place of Birth')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="dateOfBirth" class="col-sm-4 col-form-label">@lang('website.Date of Birth')</label>
                                <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        <div class="form-group row">
                            <label for="completeAddress" class="col-sm-3 col-form-label">@lang('website.Complete Address')</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-6 row">
                                <label for="educationalAttainment"
                                    class="col-sm-4 col-form-label">@lang('website.Educational Attainment')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="degree"
                                    class="col-sm-4 col-form-label">@lang('website.Degree/Course')</label>
                                <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="monthlyIncome" class="col-sm-4 col-form-label">@lang('website.Monthly Income')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="incomeSources" class="col-sm-4 col-form-label">@lang('website.Other Sources of Income')</label>
                                <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="sss" class="col-sm-4 col-form-label">@lang('website.SSS No.')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="tin" class="col-sm-4 col-form-label">@lang('website.TIN No.')</label>
                                <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-12 col-md-6 row">
                                <label for="department" class="col-sm-4 col-form-label">@lang('website.Department Area')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="localNo" class="col-sm-4 col-form-label">@lang('website.Local No.')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="cellphoneNo" class="col-sm-4 col-form-label">@lang('website.Cellphone No.')</label>
                                <div class="col-sm-8">
                    ...
                    <h5 class="m-3">@lang('I. Spouse')</h5>
                        <div class="form-group col-12 row">
                            <label for="spouseName" class="col-sm-2 col-form-label">@lang('website.Full Name')</label>
                            <div class="col-sm-10">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-12 col-md-6 row">
                                <label for="spouseContactNo" class="col-sm-4 col-form-label">@lang('website.Contact No.')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="spouseBirthdate"
                                    class="col-sm-4 col-form-label">@lang('website.Birthdate')</label>
                                <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-6 row">
                                <label for="spouseOccupation"
                                    class="col-sm-4 col-form-label">@lang('website.Occupation')</label>
                                <div class="col-sm-8">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-12 col-md-6 row">
                                <label for="spouseEmployer"
                                    class="col-sm-4 col-form-label">@lang('website.Employer')</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-12 col-md-6 row">
                                <label for="spouseMonthlyIncome" class="col-sm-4 col-form-label">@lang('website.Monthly Salary')</label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group col-12 row">
                            <label for="spouseOfficeAddress" class="col-sm-2 col-form-label">@lang('website.Office Address')</label>
                            <div class="col-sm-10">
                        ...
                        <h5 class="m-3">@lang('II. Parents')</h5>
                            <div class="form-group col-12 row">
                                <div class="col-12">
                                    <h5>A.@lang('website.Father')</h5>
                                </div>
                                <label for="fatherName" class="col-sm-2 col-form-label">@lang('website.Full Name')</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group col-12 row">
                                <label for="fatherHomeAddress" class="col-sm-2 col-form-label">@lang('website.Home Address')</label>
                                <div class="col-sm-10">
